...
// Wed Nov 07 11:49:25 CET 2007
//----------------------------------------------------


/** CUP v0.11a beta 20060608 generated parser.
  * @version Wed Nov 07 11:49:25 CET 2007
  */
public class Grm extends java_cup.runtime.lr_parser {
  ...
  protected static final short[][] _action_table = 
    ...
    "\004\005\010\011\007\001\002\000\010\006\023\007\012" +
    "\010\013\001\002\000\012\002\ufffe\006\ufffe\007\ufffe\010" +
  ...
  protected static final short[][] _reduce_table = 
    ...
    "\000\006\003\021\004\004\001\001\000\002\001\001\000" +
      ...
      switch (CUP$Grm$act_num)
		...
		Absyn.ExpList el = (Absyn.ExpList)((java_cup.runtime.Symbol) CUP$Grm$stack.elementAt(CUP$Grm$top-1)).value;
		 RESULT = new Absyn.SeqExp(lpleft, el); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 3: // exp ::= NOT LPAREN exp RPAREN 
            {
              Absyn.Exp RESULT =null;
		...
		Absyn.Exp e = (Absyn.Exp)((java_cup.runtime.Symbol) CUP$Grm$stack.elementAt(CUP$Grm$top-1)).value;
		 RESULT = new Absyn.OpExp(eleft, new Absyn.IntExp(0,0), Absyn.OpExp.NOT, e); 
